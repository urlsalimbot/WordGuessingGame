...
Partial Class GameForm1
    ...
    Friend WithEvents QBtn As Button
    ...
    Friend WithEvents YBtn As Button
    Friend WithEvents UBtn As Button
    Friend WithEvents IBtn As Button
    Friend WithEvents OBtn As Button
    Friend WithEvents PBtn As Button
    ...
    Friend WithEvents JBtn As Button
    Friend WithEvents KBtn As Button
    Friend WithEvents LBtn As Button
    Friend WithEvents ZBtn As Button
    Friend WithEvents XBtn As Button
    Friend WithEvents CBtn As Button
    Friend WithEvents VBtn As Button
